...
use( function(){
    ...
    //Asset Info
	var fileReference = this.imgSrc || properties['./fileReference'],
		...
		isRemoteAsset = false,
		s7assetType = "",
		viewerPreset = this.viewerPreset || properties['s7ViewerPreset'],
    ...
    title = properties['jcr:title'],
		alt = this.altText || properties['alt'],
		presetType = this.presetType || properties['s7PresetType'],
